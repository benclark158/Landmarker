...
class CameraScreen extends React.Component {
    ...
    render() {
        ...
        <>
          ...
          <View style={styles.sideBContainer}>
            <TouchableOpacity style={styles.utilButton} onPress={() => this.toggleSubview()}>
              <Image
              style={{flex: 1}}
              source={{uri: 'https://facebook.github.io/react-native/img/tiny_logo.png'}}
            />
            ...
            <Animated.View
                ...
                {transform: [{translateY: this.state.bounceValue}], height: this.state.viewHeight}]}
            >
                <View style={{right: 0, display: 'flex', width: '25%', marginLeft: '75%'}}>
